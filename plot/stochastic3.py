...
(const, data) = read_csv("../output/pandas-example_cell_flagellas_M_N_stochastic_3.py(2,20)_20200528T020242_52185")
...
fig.suptitle('Flagella length dynamics when one of flagellas is cut')
