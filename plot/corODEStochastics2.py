...
file1 = "../output/pandas-example_cell_flagellas_M_N_ode_2.py(2,0)_20200528T115516_96537"
file2 = "../output/pandas-example_cell_flagellas_M_N_stochastic_2.py(2,20)_20200528T015903_10943"
...
for p in pairs:
    ...
    corcoef.append(np.corrcoef(f1_vals, f2_vals))
...
axs[0].scatter(correlations[0][0], correlations[0][1], label='Flagella #1 length ' + str(corcoef[0]))
axs[1].scatter(correlations[1][0], correlations[1][1], label='Flagella #2 length ' + str(corcoef[1]))
axs[2].scatter(correlations[2][0], correlations[2][1], label='Zone A elements ' + str(corcoef[2]))
