...
pulses = [
    pbf.Pulse(0, "A", 800),
    pbf.Pulse(0, "flagella_0_U", 200),
    pbf.Pulse(0, "flagella_1_U", 0),
    pbf.Pulse(750, "flagella_0_U", 0),
    pbf.Pulse(t_end, '', 0)
    ]
...
plt.plot(T, Y[:, sys.compositorIndex('flagella_0_U')], label="Flagellar #1 length")
plt.plot(T, Y[:, sys.compositorIndex('flagella_1_U')], label="Flagellar #2 length")
