...
def init_constants(sys):
    ...
    sys.addConstant('betab', 0.2) # ift container, take fraction
...
# pulses = [
#     pbf.Pulse(0, "flagella_0", Flagella(0, 0)),
#     pbf.Pulse(0, "flagella_1", Flagella(600, 0)),
#     pbf.Pulse(t_end, '', 0)
#      ]

pulses = [
    pbf.Pulse(0, "flagella_0_L", 0),
    pbf.Pulse(0, "flagella_0_B", 0),
    pbf.Pulse(0, "flagella_1_L", 600),
